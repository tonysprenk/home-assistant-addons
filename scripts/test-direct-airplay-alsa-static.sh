...
assert_contains "$APP_DIR/config.yaml" 'version: "0.1.6"'
...
assert_contains "$APP_DIR/run.sh" 'configure_open_file_limit'
assert_not_contains "$APP_DIR/run.sh" 'Could not raise open-file limit'
